...
@Component({
    selector: 'jhi-client-commission',
    templateUrl: './client-commissions.component.html',
    styles: []
})
export class ClientCommissionsComponent implements OnInit {
    clientfees: ClientCommission[] = [];
    links: any;
    listPage: number;
    ...
    constructor(
        ...
        private clientcommissionService: ClientCommissionService,
    ...
    ngOnInit() {
        ...
        this.clientcommissionService.pms().subscribe(pmsClients => {
    ...
    search() {
        ...
        this.clientcommissionService.clientFeeSearch(this.allSearch).subscribe(allDatas => {
    ...
    clientfeeCommissionList(pageNumber?: number) {
        ...
        this.clientcommissionService
            ...
            .subscribe(
                (res: HttpResponse<ClientCommission[]>) => this.success(res.body, res.headers),
    ...
    deleteClientFeeCommisson(clientfees): void {
        swal({
            ...
            if (result.value) {
                this.clientcommissionService.delete(clientfees.id).subscribe(data => {
