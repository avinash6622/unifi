...
import com.bcad.application.domain.User;
import com.bcad.application.repository.UserRepository;
import com.bcad.application.security.AuthoritiesConstants;
import com.bcad.application.service.MailService;
import com.bcad.application.service.UserService;
import com.bcad.application.service.dto.UserDTO;
import com.bcad.application.web.rest.errors.BadRequestAlertException;
import com.bcad.application.web.rest.errors.EmailAlreadyUsedException;
import com.bcad.application.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public UserResource(UserService userService, UserRepository userRepository, MailService mailService,
                        RelationshipManagerRepository relationshipManagerRepository, DistributorMasterRepository distributorMasterRepository,
                        SubRMRepository subRMRepository) {
    ...
    /**
     * @return a list of the RM
     */
    @GetMapping("/users/rm")
    @Timed
    public List<RelationshipManager> getRelationshipManager() {
        return relationshipManagerRepository.findAll();
    }

    @GetMapping("/users/sub-rm")
    @Timed
    public List<SubRM> getSubRM() {
        return subRMRepository.findAll();
    }

    @GetMapping("/users/dist-master")
    @Timed
    public List<DistributorMaster> getDistributors() {
        return distributorMasterRepository.findAll();
    }
    ...
    public Optional<User> getCurrentUse(String username)
    {
