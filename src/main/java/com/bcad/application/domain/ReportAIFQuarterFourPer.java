...
@Entity
@Table(name = "report_aif_q4_jm")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ReportAIFQuarterFourPer extends AbstractAuditingEntity implements Serializable {
    ...
    @Column(name = "tot_client_fee")
    private Float totClntFee;
    ...
    public Float getTotClntFee() {
        return totClntFee;
    }

    public void setTotClntFee(Float totClntFee) {
        this.totClntFee = totClntFee;
    }
