...
public class CapitalTransaction extends AbstractAuditingEntity implements Serializable {
    ...
    public Integer getIntDeleted() {
        return intDeleted;
    }

    public void setIntDeleted(Integer intDeleted) {
